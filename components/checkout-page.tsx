        ...
        <div className="w-full max-w-md rounded-2xl border border-white/10 bg-gradient-to-br from-card to-[#0d0d16] p-6 sm:p-8">
          ...
          <div className="mt-6 flex justify-center">
            <div className="rounded-2xl bg-white p-5">
              <QRCodeSVG value={PIX_KEY} size={220} fgColor="#000000" bgColor="transparent" level="M" />
            </div>
          </div>

          <p className="mt-6 text-sm font-medium text-muted-foreground">{t("checkout.pixKeyLabel")}</p>
          <div className="mt-2 flex items-stretch gap-2">
            <code className="flex min-w-0 flex-1 items-center overflow-x-auto rounded-xl border border-white/10 bg-secondary px-4 py-3 font-mono text-sm">
              {PIX_KEY}
            </code>
            <button
              type="button"

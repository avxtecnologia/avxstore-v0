  ...
  pt: {
    translation: {
      ...
      checkout: {
        ...
        pixKeyLabel: "PIX Copia e Cola (cole diretamente no app do seu banco):",
        copy: "Copiar",
        copied: "Copiado ✓",
  ...
  en: {
    translation: {
      ...
      checkout: {
        ...
        pixKeyLabel: "PIX Copy & Paste (paste directly into your bank app):",
        copy: "Copy",
        copied: "Copied ✓",
  ...
  es: {
    translation: {
      ...
      checkout: {
        ...
        pixKeyLabel: "PIX Copia y Pega (pega directamente en la app de tu banco):",
        copy: "Copiar",
        copied: "Copiado ✓",
